...
//    // if outside left or right edge, bounce horizontally
//    if (_x < 0 || _x  > _window->getWidth()) {
//        _vx = -_vx;
//    }
//    // if outside top or bottom edge, bounce vertically
//    if (_y < 0 || _y  > _window->getHeight()) {
//        _vy = -_vy;
//    }

//    if (_x < 0){
//        _x = 0+_vx+2*MAX_VELOCITY;
//    }
//    if(_x > _window->getWidth()){
//        _x = _window->getWidth()+_vx+2*MIN_VELOCITY;
//    }
//    if(_y < 0){
//        _y = 0 + _vy+2*MAX_VELOCITY;
//    }
//    if(_y > _window->getHeight()){
//        _y = _window->getHeight()+_vy+2*MIN_VELOCITY;
//    }
}
